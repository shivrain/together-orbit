...
export type Deal={id:string;companyId:string;name:string;startup:string;link:string;reason:string;referrer:string;referrerEmail:string;category:string;stage:Stage;owner:string;permission:"Yes"|"Ask first";followUp:string;notes:string;messages:MailMessage[];updatedAt:string;unread:boolean;source:"email"|"manual"|"sample";providerThreadId?:string;referrerPersonId?:string};
export type Contact={id:string;companyId:string;name:string;email:string;role:string;interests:string;kind?:"Founder"|"Leadership"|"Team"|"Alumni";profile?:string;sourceUrl?:string;notes?:string;lastContactAt?:string;nextFollowUpAt?:string};
export type MailDraft={id:string;companyId:string;to:string;subject:string;body:string;status:"Draft"|"Saved to Gmail";providerId?:string;providerRevision?:string;createdAt:string;dealId?:string;personId?:string};
...
export type Movement={id:string;companyId:string;person:string;profile:string;previousRole:string;currentRole:string;previousCompany:string;currentCompany:string;type:"Departure"|"New role"|"Started company";observedAt:string;sourceUrl:string;provider:"Clay"|"Harmonic"|"Public source";evidence:string;confirmed:boolean;personId?:string};
